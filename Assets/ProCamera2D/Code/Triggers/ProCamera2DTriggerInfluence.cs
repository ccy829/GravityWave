...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    public class ProCamera2DTriggerInfluence : BaseTrigger
    {
        ...
        IEnumerator InsideTriggerRoutine()
        {
            ...
            while (_insideTrigger)
            {
                ...
                else
                {
                    ...
                    _influence = Vector3.SmoothDamp(_influence, -vectorFromPointToFocus * (1 - distancePercentage), ref _velocity, InfluenceSmoothness);
                    ProCamera2D.ApplyInfluence(_influence);
        ...
        IEnumerator OutsideTriggerRoutine()
        {
            ...
            {
                _influence = Vector3.SmoothDamp(_influence, Vector2.zero, ref _velocity, InfluenceSmoothness);
                ProCamera2D.ApplyInfluence(_influence);
